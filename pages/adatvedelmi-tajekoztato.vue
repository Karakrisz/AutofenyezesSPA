...
<template>
  <section>
    <div class="subpage">
      <h4
        class="aszf-content__h4 blog-box__text__h3 text-transform-uppercase"
      >
        Adatkezelési Tájékoztató
      </h4>

      <p class="aszf-content__p">Elfogadás dátuma: 2025.09.18</p>

      <h5
        class="aszf-content__h5 blog-box__text__h3 text-transform-uppercase"
      >
        1. ADATKEZELŐ
      </h5>
      <p class="aszf-content__p">szerviz@autofenyezes.com</p>
      ...
      <p class="aszf-content__p">
        ...
        szerviz@autofenyezes.com e-mail címre küldött üzenettel keresse meg az
        Adatkezelőt.
      </p>
      ...
      <h5
        class="aszf-content__p blog-box__text__h3 text-transform-uppercase"
      >
      ...
      <h5
        class="szf-content__h5 blog-box__text__h3 text-transform-uppercase"
      >
